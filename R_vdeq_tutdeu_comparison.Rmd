...
j_ssn1a <- SSN2::ssn_import("E:/R_vdeq_sci/Working/Data/neptune_analysis/ssn_objects/James040424.ssn", predpts = "sites")
# pull set of observation data out from ssn
DFobs <- SSN2::ssn_get_data(j_ssn1a)
summary(DFobs$VSCIVCPMIVCPMI)
```
...
write.csv(models_yintercept, file="E:/R_vdeq_sci/Working/Data/neptune_analysis/scripts_by_basin/tables_sf/models_yintercept.csv",sep=",",row.names=F)
```
