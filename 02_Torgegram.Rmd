...
Stations are flow-uconnected when they are on different branches of the stream network and share a confluence. The calculation of gamma remains the same, but the average distance is restricted to those pairs of stations that are flow-unconnected.
...
Stations are flow-connected when they have an upstream to downstream relationship. The calculation of gamma remains the same, but the average distance is restricted to those pairs of stations that are flow-unconnected. Why might the flow-connected Toregram look so wonky? 
```{r torg_flow_unconnect}
