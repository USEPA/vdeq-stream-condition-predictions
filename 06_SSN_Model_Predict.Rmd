...
From cv_resids, use fitted_vals and resid_Se to make ribbon for LOOCV fitted interval so to identify obs having interesting vsci values
...
# TLH fitted to obs interval plot (LOOCV method)
On 01/14/2025 inserted TLH's code using observation-specific LOOCV variance so get squiggly 90th percentile lines in ggplot.
...
# Carson Code Points Outside LOOCV 90% Prediction Limit for 199 obs
#This code comes from local_SSN_FINAL_20160126_modelling.html 
...
01/14/2025 added Travis' code to make prediction of 199 sites vsci versus observed vsci as ggplot using same variance for each obs so get straight 90th percentile lines
