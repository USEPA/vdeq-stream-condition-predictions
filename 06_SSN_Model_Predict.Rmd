...
# head(round(aug_z4ssn_wswq_reml1$vsci))
...
a5predict1ws_vsci$.residuals <- a5predict1ws_vsci$vsci-a5predict1ws_vsci$.fitted

# pull sd of residuals and fitted values
resid_SD = sd(a5predict1ws_vsci$.residuals)
