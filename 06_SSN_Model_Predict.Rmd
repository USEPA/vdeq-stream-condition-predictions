...
# plot
plot(tx,ty,xlim=range(na.omit(tx)),ylim=range(na.omit(ty),na.omit(op95)),xlab="VSCI Predicted Value 2019-2022",ylab="VSCI Observed Value 2019-2022",main="Spatial Model Observed vs. Predicted a5 reml JU Partitioned & Upstream Waterbody Distance")
abline(0,1,col="red")
lines(lowess(na.omit(tx),na.omit(ty)),col='blue')
