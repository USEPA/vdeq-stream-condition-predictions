...
# combine to a dataframe note variance/se is same for 
# all obs
spat<-cbind(fitted_vals,resid_SD^2)
head(spat)
# spatial prediction percentiles
...
# combine to a dataframe and se.fit/variance differs 
...
# sd a vector of standard deviations, the square root of # our squared .se.fit
(spat.Pred.pct<-t(apply(spat,1,function(x) qnorm(c(Q05=0.05,Q10=0.1,Q25=0.25,Median=0.5,Q75=0.75,Q90=0.9,Q95=0.95),x[1],sqrt(x[2])))))
