...
# plot
plot(tx,ty,xlim=range(na.omit(tx)),ylim=range(na.omit(ty),na.omit(op95)),xlab="Total Phosphorous Predicted Value",ylab="Total Phosphorous Observed Value",main="Spatial Model Observed vs. Predicted")
abline(0,1,col="red")
