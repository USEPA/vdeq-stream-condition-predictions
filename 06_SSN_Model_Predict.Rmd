...
# put all components into data frame for ggplot
plot_dat = data.frame("vsci_pred" = tx, "vsci" = ty, "pred_5th" = op05, "pred_95th" = op95,"vsci_bound_order"=tx[ox],"station_id"=DFobs$station_id_2)
...
spat_loocv1 <- cbind(cv_resids$cv_predict, cv_resids$se.fit, j_ssn3$obs$vsci)
...
station_id_2 <-dplyr::select(DFobs,station_id_2)
