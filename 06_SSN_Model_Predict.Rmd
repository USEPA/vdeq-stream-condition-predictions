...
01/14/2025 added Travis' code to make prediction of 199 sites vsci versus observed vsci as ggplot
...
# combine to a dataframe note variance same for all ob
spat<-cbind(fitted_vals,resid_SD^2)
head(spat)
...
This is producing a 90% prediction interval. Is the spatial prediction percentiles using qnorm from TLH and JC code more accurate?
...
rm(cv_resids, fitted_vals, spat, spat.Pred.pct, spat.Pred.median, ty, tx, ox, op05, op95, os90pl.sp)
```
