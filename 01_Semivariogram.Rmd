...
Calculating a robust semivariogram lets us assess if outliers could be affecting the spatial pattern. Output from this code chunk will be under the Plots tab.
```{r robust_semivar}
